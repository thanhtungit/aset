...
akeeba.Update.setProgressBar=function(a,b){void 0==b&&(b="downloadProgressBar");var c=0,c=1>=a?100*a:a;0>c&&(c=0);100<c&&(c=100);var d=document.getElementById(b),e=document.getElementById(b+"Info");d.className=100>c?"akeeba-progress-fill":"akeeba-progress-fill--success";document.getElementById(b).style.width=c.toFixed(1)+"%";e.innerText=c.toFixed(1)+"%";Piecon.setProgress(c)};
