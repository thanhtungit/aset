...
document.getElementById("akeeba-transfer-ftp-method").removeAttribute("disabled");var c=document.getElementById("akeeba-transfer-ftp-error"),d=document.getElementById("akeeba-transfer-ftp-error-body"),e=document.getElementById("akeeba-transfer-ftp-error-force");e&&(e.style.display="none",a.ignorable&&(e.style.display="inline-block"));d.innerHTML=a.message;c.style.display="block";akeeba.System.triggerEvent(c,"focus");akeeba.Transfer.onTransferMethodChange()}},function(a){document.getElementById("akeeba-transfer-apply-loading").style.display=
...
akeeba.Transfer.uploadKickstart=function(){var a=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),b=document.getElementById("akeeba-transfer-upload-lbl-archive"),c=document.getElementById("akeeba-transfer-upload-error");c.style.display="none";a.className="akeeba-label--orange";b.className="akeeba-label--grey";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display="none";document.getElementById("akeeba-transfer-upload-area-upload").style.display="block";document.getElementById("akeeba-transfer-upload").style.display=
"block";akeeba.System.doAjax({task:"initialiseUpload"},function(b){b.status?akeeba.Transfer.uploadArchive(1):(a.className="akeeba-label--red",c.innerHTML=b.message,c.style.display="block")},null,!1,15E4)};
akeeba.Transfer.uploadArchive=function(a){void 0===a&&(a=0);var b=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),c=document.getElementById("akeeba-transfer-upload-lbl-archive"),d=document.getElementById("akeeba-transfer-upload-error");d.style.display="none";b.className="akeeba-label--green";c.className="akeeba-label--orange";akeeba.System.doAjax({task:"upload",start:a},function(a){if(a.result)if(a.done){document.getElementById("akeeba-transfer-upload-percent").textContent="100 %";
document.getElementById("akeeba-transfer-upload-size").innerHTML="";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display="block";document.getElementById("akeeba-transfer-upload-area-upload").style.display="none";var b=document.getElementById("akeeba-transfer-url").value.replace(/\/$/,"")+"/kickstart.php";document.getElementById("akeeba-transfer-upload-btn-kickstart").setAttribute("href",b)}else{var b=0,f=1*a.totalSize;a=1*a.doneSize;0<f&&0<a&&(b=100*(a/f));document.getElementById("akeeba-transfer-upload-percent").textContent=
b.toFixed(2)+"%";document.getElementById("akeeba-transfer-upload-size").textContent=a.toFixed(0)+" / "+f.toFixed(0)+" bytes";window.setTimeout(function(){akeeba.Transfer.uploadArchive(0)},50)}else c.className="akeeba-label--red",d.innerHTML=a.message,d.style.display="block"},null,!1,15E4)};
