...
akeeba.Wizard.tryAjax=function(){akeeba.System.useIFrame=!1;akeeba.Backup.resetTimeoutBar();akeeba.Backup.startTimeoutBar(1E4,100);document.getElementById("step-ajax").className="akeeba-label--teal";document.getElementById("backup-substep").textContent=akeeba.Wizard.translation.COM_AKEEBA_CONFWIZ_UI_TRYAJAX;akeeba.System.doAjax({akact:"ping"},function(){akeeba.System.useIFrame=!1;var a=document.getElementById("step-ajax");a.className=a.className="akeeba-label--green";akeeba.Wizard.minExec()},function(){akeeba.System.useIFrame=
!0;akeeba.Backup.resetTimeoutBar();akeeba.Backup.startTimeoutBar(1E4,100);document.getElementById("backup-substep").textContent=akeeba.Wizard.translation.COM_AKEEBA_CONFWIZ_UI_TRYIFRAME;akeeba.System.doAjax({akact:"ping"},function(){var a=document.getElementById("step-ajax");a.className=a.className="akeeba-label--green";akeeba.Wizard.minExec()},function(){document.getElementById("backup-progress-pane").style.display="none";document.getElementById("error-panel").style.display="block";document.getElementById("backup-error-message").textContent=
akeeba.Wizard.translation.COM_AKEEBA_CONFWIZ_UI_CANTUSEAJAX},!1,1E4)},!1,1E4)};
akeeba.Wizard.minExec=function(a,b){null==a&&(a=0);null==b&&(b=0);akeeba.Backup.resetTimeoutBar();akeeba.Backup.startTimeoutBar(1E3*(2*a+5),100);document.getElementById("backup-substep").textContent=akeeba.Wizard.translation.COM_AKEEBA_CONFWIZ_UI_MINEXECTRY.replace("%s",a.toFixed(1));document.getElementById("step-minexec").className="akeeba-label--teal";akeeba.System.doAjax({akact:"minexec",seconds:a},function(d){b++;3>b?akeeba.Wizard.minExec(a,b):akeeba.Wizard.minExecApply(a)},function(){a+=0.5;
20<a?(document.getElementById("backup-progress-pane").style.display="none",document.getElementById("error-panel").style.display="block",document.getElementById("backup-error-message").textContent=akeeba.Wizard.translation.COM_AKEEBA_CONFWIZ_UI_CANTDETERMINEMINEXEC):akeeba.Wizard.minExec(a,0)},!1,1E3*(2*a+5))};
akeeba.Wizard.minExecApply=function(a){akeeba.Backup.resetTimeoutBar();akeeba.Backup.startTimeoutBar(25E3,100);document.getElementById("backup-substep").textContent=akeeba.Wizard.translation.COM_AKEEBA_CONFWIZ_UI_SAVEMINEXEC;var b=0;akeeba.Backup.useIFrame&&(b=1);akeeba.System.doAjax({akact:"applyminexec",iframes:b,minexec:a},function(a){a=document.getElementById("step-minexec");a.className=a.className="akeeba-label--green";akeeba.Wizard.directories()},function(){document.getElementById("backup-progress-pane").style.display=
