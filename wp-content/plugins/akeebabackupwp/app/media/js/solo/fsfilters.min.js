...
*/
if("undefined"==typeof akeeba)var akeeba={};"undefined"===typeof akeeba.Fsfilters&&(akeeba.Fsfilters={translations:{},currentRoot:null,loadingGif:""});akeeba.Fsfilters.activeRootChanged=function(){var c=document.getElementById("active_root"),a={};a.root=c.options[c.selectedIndex].value;a.crumbs=[];a.node="";akeeba.Fsfilters.load(a)};akeeba.Fsfilters.load=function(c){c.verb="list";c=JSON.stringify(c);var a={};a.akaction=c;akeeba.System.doAjax(a,function(a){akeeba.Fsfilters.render(a)},null,!1,15E3)};
...
(akeeba.System.removeClass(d,"akion-android-star-outline"),akeeba.System.addClass(d,"akion-android-star")):-1!=d.className.indexOf("akion-android-star")&&(akeeba.System.addClass(d,"akion-android-star-outline"),akeeba.System.removeClass(d,"akion-android-star"))},250);akeeba.System.data.set(a,"akeebatimer",e)}var b={akaction:JSON.stringify(c)};akeeba.System.doAjax(b,function(b){if(null!=a){var e=akeeba.System.data.get(a,"akeebatimer");clearInterval(e);if(e=akeeba.System.data.get(a,"iconClass"))d.className=
e;akeeba.System.data.set(a,"iconClass",null);akeeba.System.data.set(a,"loading",null)}!0==b.success?(null!=a&&g&&(!0==b.newstate?(akeeba.System.removeClass(a,"akeeba-btn--grey"),akeeba.System.addClass(a,"akeeba-btn--orange")):(akeeba.System.removeClass(a,"akeeba-btn--orange"),akeeba.System.addClass(a,"akeeba-btn--grey"))),null!=f&&f(b,a)):(null!=f&&f(b,a),akeeba.System.modalErrorHandler(akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_LABEL_UIERRORFILTER.replace("%s",c.node)))},function(b){if(null!=
a){var c=akeeba.System.data.get(a,"akeebatimer");clearInterval(c);d.className=akeeba.System.data.get(a,"iconClass");akeeba.System.data.set(a,"iconClass");akeeba.System.data.set(a,"loading")}akeeba.System.params.errorCallback(b)},!0,15E3)};
...
b.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>'),b.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL+"</div>"),b.setAttribute("data-akeeba-tooltip-position","right"),akeeba.Tooltip.simpleTooltip(b),akeeba.System.addEventListener(b,"click",function(b){return function(){var b;-1!=this.className.indexOf("akeeba-btn--orange")?(akeeba.System.removeClass(this,"akeeba-btn--orange"),
