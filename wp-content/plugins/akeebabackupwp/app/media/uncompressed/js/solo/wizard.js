...
akeeba.Wizard.tryAjax = function ()
{
	...
	akeeba.System.doAjax(
		...
		function ()
		{
			...
			akeeba.Backup.resetTimeoutBar();
			akeeba.Backup.startTimeoutBar(10000, 100);
			document.getElementById('backup-substep').textContent = akeeba.Wizard.translation['COM_AKEEBA_CONFWIZ_UI_TRYIFRAME'];
			akeeba.System.doAjax(
				{akact: 'ping'},
				function ()
				{
...
akeeba.Wizard.onDatabaseDriverChange = function (e)
{
	...
	document.getElementById('port-wrapper').style.display   = 'block';
	...
	document.getElementById('prefix-wrapper').style.display = 'block';
