...
?>
<nav class="woocommerce-MyAccount-navigation col-md-12 float-left col-lg-4">
	<h3>My Account</h3>
	<ul>
   ...
   <?php
	...
	<div class="box box-my-cart">
		<div class="list-content-cart">
            <h5>My Cart <a href="<?php echo wc_get_cart_url(); ?>">View Full</a></h5>
            <p class="count_items">There are <strong><?php echo  WC()->cart->get_cart_contents_count(); ?> items</strong> in your cart</p>
            <p class="total"><strong>Cart Total: <?php echo WC()->cart->get_cart_total();  ?></strong></p>
            <p class="group-btn"><a href="<?php echo esc_url( wc_get_checkout_url() );?>" class="checkout-button button alt wc-forward btn-green">
                    <?php esc_html_e( 'Checkout', 'woocommerce' ); ?>
                </a></p>
        </div>
       <div class="list-items-cart">
           <table class="list-cart shop_table">
