    ...
    <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
        ...
        <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
            ...
            <tr>
                ...
                <th class="product-subtotal"><?php esc_html_e( 'Subtoltal', 'woocommerce' ); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                <td colspan="6" class="actions">
                    ...
                    <?php if ( wc_coupons_enabled() ) { ?>
                        <div class="coupon">
                            <p>Discount Codes</p>
                            <label for="coupon_code"><?php esc_html_e( 'Discount Code:', 'woocommerce' ); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Enter your coupon code if you have', 'woocommerce' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?></button>
                    ...
                    <div class="total_price">
                        <p><?php _e( 'Subtotal', 'woocommerce' ); ?>: <?php wc_cart_totals_subtotal_html(); ?></p>
                        <p><?php _e( 'Total', 'woocommerce' ); ?>: <?php wc_cart_totals_order_total_html(); ?></p>
